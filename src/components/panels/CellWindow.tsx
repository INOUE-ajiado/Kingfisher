...
import { useCellPlayback } from '../../hooks/useCellPlayback';
...
import { PaneTabBar, PaneDropGap } from './PaneTabBar';
...
export const CellWindow: React.FC = () => {
  ...
  // Space を押している間だけパン移動にする (hooks/useSpaceKey.ts)
  ...
  // エクスプローラーからの取り込みは hooks/usePaneFileDrop.ts へ
  const {
    isWinADragOver,
    isWinBDragOver,
  ...
  // コマ送り再生は hooks/useCellPlayback.ts へ
  useCellPlayback();
