  ...
  const menuData = [
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'divider' },
        { label: '表示を左へ 15° 回す', shortcut: '', action: () => rotateCanvasView(-15) },
        { label: '表示を右へ 15° 回す', shortcut: '', action: () => rotateCanvasView(15) },
        { label: '表示の角度を戻す (0°)', shortcut: '', action: resetCanvasRotation },
        { type: 'divider' },
    ...
    },
    {
      ...
      items: [
        ...
        { label: '回転ビュー (表示を傾ける)', shortcut: 'R', action: () => setActiveTool('rotateView') },
      ],
    },
    {
      id: 'window',
